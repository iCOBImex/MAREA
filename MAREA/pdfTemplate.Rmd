...
reg_table(model = results_bio$model[[1]],
...
if(!is.na(results_bio$model[[2]])) {
  ...
  reg_table(model = results_bio$model[[2]],
...
if(!is.na(results_bio$model[[3]])) {
  ...
  reg_table(results_bio$model[[3]],
            title = "Tabla de regresion para organizmos maduros",
